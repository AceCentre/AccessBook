= Getting Started with AAC: Accessing the computer
Katharine Buckley
v1.2, 2017-15-03
:toc: right
:toclevels: 3
...
(c) The copyright for Makaton, vocabulary signs and symbol graphics is owned by The Makaton Charity (http://www.makaton.org)
...
Widgit Symbols (c) Widgit Software 2002-2015 http://widgit.com
...
.In this chapter:
****
• Remind ourselves what communication is all about +
• Get to grips with the jargon +
• Feel inspired about what low tech AAC can achieve +
• Meet children who use low tech AAC +
****
...
AAC is often divided into <<aided-aac, Aided>> and <<unaided-aac, Unaided>> categories. Aided AAC describes any type of AAC that uses some sort of equipment, be it a pencil or a computer. Unaided AAC is communication that you do using your body with no other equipment. This basically means gesture and signing.
...
• Makaton® http://makaton.org
• SignAlong http://signalong.org.uk
• BSL e.g. http://british-sign.co.uk

Aided AAC is then divided further into two or three categories, depending on who you speak to or what you are reading! Types of Aided AAC that you will hear about are low tech (at last!), <<light-tech-communication, Light tech>> and high tech. Some people don’t worry about the term light tech and just use low and high tech AAC. When they do this, the term high tech includes light tech. Others use the term ‘ <<basic-high-tech, basic high tech>> ’ instead of light tech.

Low tech AAC is AAC that uses some sort of simple equipment that doesn’t involve a battery. In a way it’s defined by what it is not, which is light or high tech AAC. Low tech AAC is often, although not always, made using paper. Examples of low tech AAC include <<objects-of-reference, objects of reference>> , symbol charts and books, alphabet charts, E-tran frames, etc. A better term might be ‘no tech’!

[sidebar]
.Gallery 1.1 Examples of High Tech AAC
--
image::high_tech-thumb.png[title="A small collection of high tech AAC devices.",link="Media/images/high_tech.png"]
image::IMG_3759_1-thumb.jpg[title="Tiago uses a communication aid that he accesses using eye movement alongside his low tech alphabet chart and speech.",link="Media/images/IMG_3759_1.jpg"]
image::Sandip_new-thumb.jpg[title="Sandip types what he wants to say on a lightwriter communication aid. He has used this to support him both at work and during more advanced studying, as well as in day to day life more generally.",link="Media/images/Sandip_new.jpg"]
--

A small collection of high tech AAC devices.

Light tech AAC (or basic high tech AAC) is AAC that uses simple battery powered equipment. To find out more about what’s available, see Speech Bubble (http://speechbubble.org.uk).

The photograph below shows some examples of light tech AAC devices. The pen is included to give an indication of size. All of these more simple devices play back <<pre-recorded-speech,pre recorded speech>> .

image::kYUPpnN-thumb.jpg[title="Recorded Speech Devices", alt="Recorded Speech Devices", width="300", link="Media/images/kYUPpnN.jpg"]

High tech AAC is AAC that uses more complex equipment such as computers, tablets and iPads / iPods. High tech AAC options tend to make use of <<synthesised-speech, synthesised speech>>. To find out more about what’s available, see Speech Bubble (http://speechbubble.org.uk). The photographs in Gallery 1.1 show just a few examples of high tech AAC devices. There are many, many options out there, in all sorts of shapes, sizes and specifications.

==== Representing Meaning through Objects and Symbols

As you will see, low tech AAC comes in many shapes and forms. However, broadly speaking you will find low tech AAC based around objects of reference, <<symbols, symbols>> , whole words and letters.
...
image::EavHR7E-thumb.jpg[title="Objects of Reference", alt="Objects of Reference", width="300", link="Media/images/EavHR7E.jpg"]
...
Beth is a young woman who uses AAC to support her communication. She now attends university, but made this film a few years ago to illustrate how she communicates. She has kindly given permission for her film to be shared here. You can find out more about Beth at http://bethmoulam.com.

==== Who Uses AAC?

AAC is used by people of all ages and abilities - from young toddlers to the elderly, from people with advanced degrees to those with learning difficulties. There are many different reasons why people need to use AAC to support or replace their speech. A person may have been born with a condition such as <<cerebral-palsy, cerebral palsy>> or a syndrome such as Down’s syndrome or Angelman syndrome, have autism or an autistic spectrum condition, have a learning disability, have difficulties with speech and language following a head injury, stroke or brain tumour, have developed a progressive neurological condition... the list is endless. What unites this incredibly diverse group of people is the fact that their speech does not enable them to communicate in all situations or with all individuals without some extra support.
...
“Using AAC makes me feel like I exist, it gives me the power to make a contribution and it enables more people to communicate with me. Without AAC – I may as well be asleep.” (from http://toby-churchill.com)

=== Section 1: Meet Some Children Who Use Symbol Based Low Tech AAC

==== Ria

image::LD80lVB-thumb.jpg[title="Ria", alt="Ria", width="300", link="Media/images/LD80lVB.jpg"]
...
image::bYVDPB1-thumb.jpg[title="Ria with Communication Book", alt="Ria with Communication Book", width="300", link="Media/images/bYVDPB1.jpg"]
...
.Movie 1.2 Ria playing with bubbles
video::GaAx4zSOESg[youtube]
...
image::http://i.imgur.com/DmSxTyv.png[title="Callum", alt="Callum", width="300", link="http://i.imgur.com/DmSxTyv.png"]
...
image::utyxztp-thumb.jpg[title="Tasmin and her brother", alt="Tasmin and her brother", width="300", link="Media/images/utyxztp.jpg"]
...
[[watch-this-video-of-tamsin]]
.Movie 1.3 Tamsin chatting to a visitor
video::rv7mN6fA1KA[youtube]
...
.In this chapter:
****
* Understand why low tech AAC is so important
* Feel reassured about using AAC with children
...
If you would like to read some of the journal articles around this area, there is a great list of relevant articles here http://acecent.re/1G0IC2C. You will also find a good summary of the issues and research here http://acecent.re/1Ls09EV.
...
You will find lots of examples in <<chapter-5,Chapter 5>>. Here are some examples. Or have a go and <<make-your-own,make your own>>
...
Getting started with AAC needs to be fun for everyone. In time, the use of AAC will hopefully develop into a robust communication system that can be used to talk about problems, do maths homework, and to have an argument about how much television it’s ok to watch! But in the beginning, we need to try and keep it fun and motivating. <<no-fail-activities, No fail activities>> are a great place to start.
...
.In this chapter:
****
• Think about symbol sets +
• Find out about symbol sets that are used in the UK +
• Think about how symbols are learned +
• Find out about how to make symbol-based resources +
• Consider the role of photographs in a symbolbased system +
****

A symbol is a pictorial representation of a word or concept, and a <<symbol-set, symbol set>>  is a collection of such drawings. Symbols differ from pictures or clip art in that they follow design rules in how they are drawn.
...
--
image::makaton-thumb.jpg[title="Makaton® symbols (http://makaton.org/aboutMakaton/howMakatonWorks).",link="Media/images/makaton.jpg"]
image::pcs-thumb.jpg[title="PCS or Picture Communication Symbols (http://mayer-johnson.com/pcs-collections).",link="Media/images/pcs.jpg"]
image::symbolstix-thumb.jpg[title="SymbolStix symbols.",link="Media/images/symbolstix.jpg"]
image::symbolstix-thumb.jpg[title="Widgit symbols (http://widgit.com/symbols/about_symbols/widgit_symbols.htm).",link="Media/images/symbolstix.jpg"]
--



Although Makaton®, PCS (Picture Communication Symbols), SymbolStix and Widgit symbols are perhaps the most commonly used, there are others available. Other sets that are sometimes seen include Bliss symbols (http://blissymbols.co.uk ), Pictogram symbols (http://pictoworld.com/index.html), Clarity symbols (http://liberator.co.uk/clarity-symbols.html), amongst others! There are also a number of freely available symbol sets around. A useful comparison of symbol sets can be found at: http://spectronics.com.au/article/symbol-set-comparison.
...
Some of the symbol sets offer special symbols for people with visual difficulties. Widgit offers a set of VI symbols (http://widgit.com/products/vi/index.htm) for example, and PCS offers a set of high contrast symbols (http://mayerjohnson.com/pcs-classic-high-contrast).
...
image::FuB3fil-thumb.jpg[title="Shapes and Texture Symbols", alt="Shapes and Texture Symbols", width="300", link="Media/images/FuB3fil.jpg"]

The above picture is an example of a very ‘home made’ chart that uses personalised tangible symbols. It is also possible to produce tangible symbols using a Zychem printer - see http://www.zychem-ltd.co.uk.

You can find out more about the use of tangible symbols here http://library.tsbvi.edu/Browse/Category/15.

[[it-is-not-always-easy-to-draw-a-picture-of-a-core-word]]
...
To help children learn to use these symbols, we need to use them ourselves as often as possible when talking to them. This is the very best way of making them easier to learn. See <<chapter-8,Chapter 8, Communication Partner Skills>>, for more information.
[[make-your-own]]
...
• Boardmaker Plus! V6 or Boardmaker Studio - available
from, e.g., http://toby-churchill.com
• Communicate in Print 2- available from, e.g., http://widgit.com
• Matrix Maker Plus - available from, e.g., http://inclusive.co.uk
...
However, just for getting started, you could make use of some of the charts we have given as examples in <<chapter-5,Chapter 5>> . All the charts shown are available to download from ACE Centre’s website (http://acecentre.org.uk).
To protect your charts, it may be worth considering laminating them. If you are in settings with lots of overhead lights, matt laminating pouches may make it easier for all to see the symbols. Alternatively you might want to print them using ‘indestructible’, ‘waterproof’ or ‘non-tear’ paper.
...
Photographs can have another role to play in communication though. They are a great way to share stories <<share-stories,share stories>> (link) about people, activities and events.
...
--
image::photo-busy-thumb.png[title="This photograph is taken against a busy toy shelf. The game itself is rather lost amongst all the clutter.",link="Media/images/photo-busy.png"]
...
When creating your own charts, one of the first considerations is what words to use! This chapter takes a look at the thinking behind what words to include. Chapter 5 then provides lots of practical examples that can all be downloaded from ACE Centre’s website (http://acecentre.org.uk).

=== What Words Should You Use?

.In this chapter:
****
• Think about what sort of vocabulary can be included in a communication chart
• Learn more about ‘core’ vocabulary
****

When getting started with AAC, the temptation is often to focus on <<choice-making,choice making>> , but it is important to remember that communication involves so much more than just choosing or asking for things!
...
This video is a good reminder of what communication is all about. Ruben’s Mum reads aloud a series of options to Ruben, and he indicates ‘yes’ when he hears the word or phrase that he wants to say. This method of accessing AAC is called auditory scanning - it is a form of <<listener-mediated-scanning,listener mediated scanning>> .

.Movie 4.1 Communication is about more than making choices
video::2bFip35_Kto[youtube]
...
These examples are far from an exhaustive list. Children can say so much! Even very young children with a relatively small vocabulary are extremely creative and have lots of different types of things to say. From Chapter 1, <<watch-this-video-of-tamsin,watch this video of Tamsin>> , aged five, telling a visitor about something unexpected that had happened to her!
...
image::gPJ9u8d-thumb.jpg[title="Cafe Chart", alt="Cafe Chart", width="300", link="Media/images/gPJ9u8d.jpg"]
...
image::2t9nCM2-thumb.jpg[title="Cafe Chart Expanded", alt="Cafe Chart Expanded", width="300", link="Media/images/2t9nCM2.jpg"]
...
When thinking about vocabulary (or words) within AAC, we tend to divide it into <<core, 'core'>> words and <<fringe, 'fringe'>> words.
...
As discussed in Chapter 3, <<it-is-not-always-easy-to-draw-a-picture-of-a-core-word,it is not always easy to draw a picture of a core word>> . The difficulty of drawing a picture to represent such concepts as ‘more’ or ‘want’, for example, should not deter us from including these core words in communication books and charts. With the <<chapter-8,right support from communication partners>> , people can learn to use these well. Indeed with some short core words, it is arguably as easy to learn the written word as the abstract symbol. In these situations, you may just want to teach the actual word rather than the symbol. The word can be introduced and taught in the same way as the symbol would be.
...
In Chapter 5, you will find some examples of <<core-vocabulary-charts,core vocabulary charts>>.
...
• Gail van Tatenhove has produced some handouts on vocabulary lists – see http://vantatenhove.com/ papers.shtml
• There are various vocabulary lists here http://aac.unl.edu/vocabulary.html

You will also find a suggested core vocabulary in the ACE Centre guides <<developing-and-supporting-a-communication,Developing and Supporting a Communication Book>> and <<look2talk,Look2Talk>> , and core vocabulary used throughout the <<PODD-Pragmatic-Organisation-Dynamic-Display,PODD>>.
...
.In this chapter:
****
• See some ideas for getting started with symbol based low tech AAC
• Explore example charts that you can <<http//:acecentre.org.uk/symbol-charts, download>> from the ACE Centre website and use yourself
• Feel inspired to create your own charts to meet the needs and interests of the child you support
****

Getting started with low tech AAC can feel daunting! This section gives you some ideas about how you might begin. It includes examples of communication charts that you can download from ACE Centre’s website (http://acecentre.org.uk) and use to get started. However, you will soon want to adapt these and make your own.
...
Remember – the charts are there to be used by you. If the child begins to join in, that’s great, but don’t force them to use the symbols. They need to become really familiar with the symbols and how to use them. That can only happen by you using them yourself as you talk to your child. You really are the key to getting started with AAC. Your skill at pointing to the symbols while talking to, and playing with, your child is what will get AAC going. You can read much more about this in <<chapter-8, Chapter 8, Communication Partner Skills>>.

The example charts are designed to be accessed by pointing to the symbols. However, you could cut the symbols out and arrange them on an E-tran frame for <<eye-pointing-communicators, eye pointing communicators>>. You could also scan through the symbols for those using <<listener-mediated-scanning, listener mediated scanning>> , although make sure that you are consistent in the order in which you offer the symbols.

The communication charts shown below are all made using PCS symbols. However, on the ACE Centre website you can also <<acecentre.org.uk/symbol-charts, download>> the equivalent charts made with Widgit and Symbolstix symbols.

There are a set of words that we use across huge numbers of different situations – these are known as <<core-words, ‘core’ words>> . In Section 1 of this Chapter, you will see some <<core-vocabulary-charts, example core vocabulary charts>> . Then in Section 3 of this Chapter, you will see examples of how you can design a <<more-imaginative-play, chart to support a specific activity>> . These charts all contain some core vocabulary too.
...
Try and choose a chart that feels a step ahead of where you think your child is. This will enable you to demonstrate the next steps as you use the chart. It’s what we do all the time with speaking children – we repeat back what they say, adding an extra word. We are all natural language teachers! You can always blank off a few symbols if you feel there are too many, and reveal them gradually. See <<chapter-8, Chapter 8>> for more discussion around this area.

Once you’ve all gained confidence in using a few charts like the ones below, the next step will be to begin to put together a communication book containing a wide range of core and topic vocabulary. See <<chapter-9, Chapter 9>> for more information.

[[core-vocabulary-charts]]
=== Section 1: Core Vocabulary / Commenting

A great way to get started with low tech AAC is to simply print off a communication chart of <<core-words,core vocabulary>> and use it whilst chatting in whatever situation you find yourself. It’s a way of commenting on what’s going on, and what your child is interested in.
...
[[gallery-5.1]]
[sidebar]
.Gallery 5.1 Example core vocabulary charts

--
image::core-2-thumb.jpg[title="The chart won't give you every word you need, nor are they intended to. You simply point to the symbols that are there as you chat.",link="Media/images/core-2.jpg"]
image::core-8-thumb.jpg[title="The chart won't give you every word you need, nor are they intended to. You simply point to the symbols that are there as you chat.",link="Media/images/core-8.jpg"]
image::Core-15-PCS--thumb.jpg[title="The chart won't give you every word you need, nor are they intended to. You simply point to the symbols that are there as you chat.",link="Media/images/Core-15-PCS-.jpg"]
...
image::yZArZKW-thumb.jpg[title="Turn Talking", alt="Turn Talking", width="300", link="Media/images/yZArZKW.jpg"]
...
image::FfuOo19-thumb.jpg[title="Bubbles", alt="Bubbles", width="300", link="Media/images/FfuOo19.jpg"]
...
image::HQ1uvk0-thumb.jpg[title="Bubbles", alt="Bubbles", width="300", link="Media/images/HQ1uvk0.jpg"]
...
.Movie 5.2 Bubbles - with more symbols
video::FzYtX-3tPRM[youtube]
A simple demonstration of how you could use the bubbles chart.
...
image::89LwD9E-thumb.jpg[title="Balloons", alt="Balloons", width="300", link="Media/images/89LwD9E.jpg"]
...
image::XCIzhRg-thumb.jpg[title="Blocks", alt="Blocks", width="300", link="Media/images/XCIzhRg.jpg"]
...
image::BNxrF0p-thumb.jpg[title="Blocks", alt="Blocks", width="300", link="Media/images/BNxrF0p.jpg"]
...
image::ywXP78x-thumb.jpg[title="Trains", alt="Trains", width="300", link="Media/images/ywXP78x.jpg"]
...
image::rOLus1Z-thumb.jpg[title="Dolls", alt="Dolls", width="300", link="Media/images/rOLus1Z.jpg"]
...
Here’s a very young <<tamsin,Tamsin>> playing with her doll using a similar chart. Tamsin is eye pointing to the symbols, and communicates “yes” by looking to her left.

.Movie 5.3 Tamsin plays with her doll
video::pOr1Q_Qn_h0&index=9[youtube]
...
image::ZCIYtv4-thumb.jpg[title="Doll Chart", alt="Doll Chart", width="300", link="Media/images/ZCIYtv4.jpg"]
...
image::A3GAXwH-thumb.jpg[title="Dressing Up Chart", alt="Dressing Up Chart", width="300", link="Media/images/A3GAXwH.jpg"]
...
image::7uZo7tZ-thumb.jpg[title="Dressing Up Chart", alt="Dressing Up Chart", width="300", link="Media/images/7uZo7tZ.jpg"]
...
image::dVg7U1m-thumb.jpg[title="Dressing Up with Make Up", alt="Dressing Up with Make Up", width="300", link="Media/images/dVg7U1m.jpg"]
...
image::HZd2CUz-thumb.jpg[title="Mr Potato Head", alt="Mr Potato Head", width="300", link="Media/images/HZd2CUz.jpg"]
...
image::l9IzGTg-thumb.jpg[title="Tea Party Chart", alt="Tea Party Chart", width="300", link="Media/images/l9IzGTg.jpg"]
...
image::30485pQ-thumb.jpg[title="Sophisticated Tea Party Chart", alt="Sophisticated Tea Party Chart", width="300", link="Media/images/30485pQ.jpg"]
...
image::gM3Yqjn-thumb.jpg[title="Medical Kit Chart", alt="Medical Kit Chart", width="300", link="Media/images/gM3Yqjn.jpg"]
...
image::cSMWJSJ-thumb.jpg[title="Chart for Kerplunk", alt="Chart for Kerplunk", width="300", link="Media/images/cSMWJSJ.jpg"]
...
image::RqxXmjk-thumb.jpg[title="Snakes and Ladders", alt="Snakes and Ladders", width="300", link="Media/images/RqxXmjk.jpg"]
...
image::zzVZo0j-thumb.jpg[title="Talking about Books", alt="Talking about Books", width="300", link="Media/images/zzVZo0j.jpg"]
...
image::1BYZgdm-thumb.jpg[title="Dear Zoo Chart", alt="Dear Zoo Chart", width="300", link="Media/images/1BYZgdm.jpg"]

Another fun activity can involve creating stories. You could make up a chart, or a series of charts, that a child could use to make up their own stories, or ‘fill in the gaps’ from a range of choices. You could even go on to use symbol based word processing software (e.g. Symwriter from Widgit http://www.widgit.com) to ‘publish’ the story! Alternatively, you could just write it out on a piece of paper and re-read it together.
...
image::wKWQcCc-thumb.jpg[title="Creating Stories", alt="Creating Stories", width="300", link="Media/images/wKWQcCc.jpg"]
...
image::NYrf5Yk-thumb.jpg[title="Peppa Pig Chart", alt="Peppa Pig Chart", width="300", link="Media/images/NYrf5Yk.jpg"]
...
image::gWTNqaM-thumb.jpg[title="Choosing Colours Chart", alt="Choosing Colours Chart", width="300", link="Media/images/gWTNqaM.jpg"]
...
image::BZFFYJF-thumb.jpg[title="Complex Craft Activities Chart", alt="Complex Craft Activities Chart", width="300", link="Media/images/BZFFYJF.jpg"]

The short video gives a demonstration of how you could use this sort of vocabulary.

.Movie 5.4 Arts and crafts
video::ruheJZnnKyQ[youtube]
...
image::dhFznIk-thumb.jpg[title="Singing Chart", alt="Singing Chart", width="300", link="Media/images/dhFznIk.jpg"]
...
image::IBqYwwQ-thumb.jpg[title="Old MacDonald Chart", alt="Old MacDonald Chart", width="300", link="Media/images/IBqYwwQ.jpg"]

Here is an example of a similar chart to use with another great action song, _The Wheels on the Bus_:

image::X3cSMiC-thumb.jpg[title="The Wheels on the Bus Chart", alt="The Wheels on the Bus Chart", width="300", link="Media/images/X3cSMiC.jpg"]
...
image::IJO0HhO-thumb.jpg[title="Talking about Photographs", alt="Talking about Photographs", width="300", link="Media/images/IJO0HhO.jpg"]
...
image::Xb8blxb-thumb.jpg[title="Bath Play Chart", alt="Bath Play Chart", width="300", link="Media/images/Xb8blxb.jpg"]
...
This video shows Ethan doing some early writing. He is able to communicate yes by looking up, and look to the right for no. He uses <<listener-mediated-scanning, Listener Mediated Scanning>> to access the alphabet. Although Ethan uses a symbol based communication book for his face to face communication, this therapy activity gives him experience of writing using letters to help develop his literacy skills.

.Movie 5.5 Ethan does some writing
video::ufVhBtjAzes[youtube]
Ethan selects letters within an early writing activity.

You can find out much more about using and adapting alphabet charts in the _Getting Started with AAC: Designing and Using Alphabet Charts_ resource.

Here is an example of a simple alphabet chart that is set out in alphabetical order:

image::jfZ7mAu-thumb.jpg[title="Alphabet Chart", alt="Alphabet Chart", width="300", link="Media/images/jfZ7mAu.jpg"]

This alphabet chart mimics the QWERTY layout found on a computer keyboard:

image::oo5Dl3b-thumb.jpg[title="QWERTY Chart", alt="QWERTY Chart", width="300", link="Media/images/oo5Dl3b.jpg"]

== Chapter 6: Chart Design - More to Think About

.In this chapter:
****
• Look more closely at design and layout issues
• Think about using colour to identify different types of symbols
****
...
image::mglnf82-thumb.jpg[title="Hello Label", alt="Hello Label", width="300", link="Media/images/mglnf82.jpg"]
...
image::mFSFrUZ-thumb.jpg[title="Apple Label", alt="Apple Label", width="300", link="Media/images/mFSFrUZ.jpg"]
[[consistency]]
=== Consistency
...
--
image::dolly-mask-ex-1-thumb.jpg[title="Here, every other symbol has been masked.",link="Media/images/dolly-mask-ex-1.jpg"]
...
image::0qlgehW-thumb.jpg[title="Dinner Mats", alt="Dinner Mats", width="300", link="Media/images/0qlgehW.jpg"]
...
image::m7nVXlI-thumb.jpg[title="Horseshoe Shaaped charts", alt="Horseshoe Shaaped charts", width="300", link="Media/images/m7nVXlI.jpg"]
...
image::8DsShVI-thumb.jpg[title="Colour Charts", alt="Colour Charts", width="300", link="Media/images/8DsShVI.jpg"]

This example (_Gallery 6.2_) shows the same chart made with a standard white background, and then with coloured

[sidebar]
.Gallery 6.2 Demonstrating the use of colour
--
image::Busy-chart-with-colour-support-plain-thumb.jpg[title="This chart is made with a plain white background in the cells and a simple black border.",link="Media/images/Busy-chart-with-colour-support-plain.jpg"]
image::Busy-chart-with-colour-support--thumb.jpg[title="The same chart now has coloured borders using the Fitzgerald key.",link="Media/images/Busy-chart-with-colour-support-.jpg"]
...
image::waOjcyD-thumb.jpg[title="Colour Chart Small", alt="Colour Chart Small", width="300", link="Media/images/waOjcyD.jpg"]

== Chapter 7: Using Low Tech AAC if Pointing is Difficult

.In this chapter:
****
• Be introduced to ways children with physical disabilities can use low tech AAC, including:
• making pointing easier
• eye pointing
• listener mediated scanning
****

Issues around how people with physical disabilities can access and use low tech AAC are explored in detail within _Getting Started with AAC: Access to low tech symbol based resources when pointing is difficult_.
...
--
image::Balloons-8-copy-thumb.jpg[title="A 'standard' symbol chart.",link="Media/images/Balloons-8-copy.jpg"]
...
Note that some children use a slightly different form of pointing system based on exchange. The most well known form of exchange is called <<pecs,PECS>> or <<pecs,Picture Exchange Communication System>> . This is a scheme which teaches people on the autistic spectrum the purpose of communication by requiring them to physically exchange a symbol with a communication partner. The symbols are secured in book with Velcro™, pulled off and given to a communication partner. Later on in the scheme, the symbols are pulled off, placed on a sentence strip, and then the sentence strip is given to a communication partner. You can find out more here http://pecs-unitedkingdom.com/.

This is an example of a PECS style communication book.

image::P1A5vbJ-thumb.jpg[title="PECS Style Communication Book", alt="PECS Style Communication Book", width="300", link="Media/images/P1A5vbJ.jpg"]
...
--
image::IMG_1493-thumb.jpg[title="The E-tran frame is held so that the child and the communication partner make eye contact through the window.",link="Media/images/IMG_1493.jpg"]
image::IMG_0074-thumb.jpg[title="The child sees the symbols on the E-tran frame",link="Media/images/IMG_0074.jpg"]
image::IMG_0082-thumb.jpg[title="The communication partner sees the mirror image of what the child sees.it can be helpful to write the labels of the symbols on the back to make it easier to work out what the child is looking at.",link="Media/images/IMG_0082.jpg"]
image::SAM_1968-thumb.jpg[title="An E-tran frame in use.",link="Media/images/SAM_1968.jpg"]
--
...
.Movie 7.1 Eye-pointing to symbols on an E-tran frame
...
--
image::IMG_0069-thumb.jpg[title="These symbols have been laminated in a glossy laminate pouch.",link="Media/images/IMG_0069.jpg"]
image::IMG_0088-1-thumb.jpg[title="The symbols are labelled on the reverse to help the communication partner. Angus is eye pointing to the 'like' symbol.",link="Media/images/IMG_0088-1.jpg"]
--
...
Symbols can also be displayed on pages that are held upright, perhaps in an Easel file as shown below. (The file shown below is part of the Look2Talk resource, but can be purchased as a standalone item from ACE Centre http://acecentre.org.uk or alternatively, you could try larger online stationery suppliers). This is how <<tamsin,Tamsin>> accesses her large vocabulary.

image::M6wlTkK-thumb.jpg[title="Easel File", alt="Easel File", width="300", link="Media/images/M6wlTkK.jpg"]
...
.Movie 7.2 A demonstration of listener mediated scanning
video::NY2D59MpxBw[youtube]
...
.In this chapter:
****
• Learn skills that will support the development of a child’s communication
****
...
The most important communication partner skill that you can learn is <<point-taking,point talking>> or <<point-taking,modelling>> . This is where you point to symbols while you talk. You are modelling how it’s done!
...
.Movie 8.1 Clare point talks while playing with bubbles
video::7BrdTSjDi2U[youtube]
...
Remember the <<five-minute-challenge,five minute challenge>> . If you set out to point to symbols all day every day it will probably feel like too big an undertaking. One way to get going is by trying to find five minutes of focused time each day.
...
.Movie 8.2 Karen expands on Ria’s selection
video::GaAx4zSOESg[youtube]
Similarly, in <<watch-this-video-of-tamsin,this video>> , Tamsin’s Mum shows Tamsin how she could develop her story further.
...
Many of these ideas are drawn from the Communication Matters resource Speaking with Someone Who Uses AAC. You can read the leaflet here http://acecent.re/25fEFEi
...
Misunderstandings can happen in all conversations, but do tend to occur more frequently in conversations involving AAC. Don’t worry about it. In the <<PODD-Pragmatic-Organisation-Dynamic-Display, PODD>> , they make use of a great symbol called ‘Oops’ on every page. If something has gone wrong, the child or communication partner simply points to this to communicate that there’s a problem. It means everyone can acknowledge and be transparent about mistakes.
If one or both of you seems confused say so, and try to get to the bottom of it. If you are really lost, you could see if the following questions helped get things back on track:

• Who are we talking about?
• What situation are we talking about?
• Is it something that happened in the present, the past or has yet to take place?

Module Four of the freely available online learning resources on http://www.aacscotland.org.uk provides more detailed information about being a good communication partner, and offers some excellent downloadable resources.
...
Some siblings love to be got involved in supporting the child who uses AAC and relish the challenge of learning how to point-talk. If they are very young, they can learn how to communicate using AAC alongside learning to talk. This can only enhance their own communication skills.
Similarly, peers such as school friends, play mates etc., can be enthusiastic and motivating communication partners.

.Movie 8.3 Tamsin and her brother play together
video::RqcZ07C-dyo[youtube]
...
Learning to read symbols should not detract from every effort being made to support children in acquiring literacy. It is only when you can spell out your message that you can truly say everything that you might want to say. You can find out more about strategies for acquiring literacy at: http://www.everyonecommunicates.org/resources/literacy.html
...
.In this chapter:
****
• Think about how to develop a communication book
• Find out about commercially available resources that can help
• Consider integrating a little voice output
• Consider the role of photo stories and remnant books alongside standard communication books and charts
****
...
As discussed above, this book will need to contain a mixture of <<core-words,Core Words>> and fringe vocabulary. In other words, a mixture of the useful words that are relevant whatever is being discussed, and those words that are used for specific topics or activities. Make sure that the core words are easily accessible no matter what’s being talked about.
...
Sometimes people make books in A5 files, others go for A4. You can also use Filofaxes (though printing and hole punching pages can be quite fiddly as the pages are not always a ‘standard’ size) or slip printed pages into photo pocket albums. Some companies also offer <<creative-communication-book-options,creative communication book options>>.
...
Communication books are often organised by topics e.g. people, food, activities, toys, etc. However, the <<PODD-Pragmatic-Organisation-Dynamic-Display,PODD>> approach uses the type of thing being talked about as a starting point e.g. ‘something’s wrong’ or ‘I want to go somewhere’ or ‘I’m asking a question’, etc.

You don’t just need to start at the index page and go to a topic page and back again. You can also design a communication book that has links to encourage quick and easy movement between pages too. This is very much how the <<PODD-Pragmatic-Organisation-Dynamic-Display,PODD>> approach works. So for example, on a clothing page, you might also put a link to a colours page so that the person can indicate or request to quickly turn to the colours page, without first going from the clothes page to the index page and then to the colours page. Obviously this is slightly less important if the child is turning pages completely independently, but including such links can still act as a prompt to expand their conversation.
...
[[chailey-communication-system-ccs]] *Chailey Communication System (CCS)* is a resource developed by the Chailey Heritage School. It is a structured low tech communication book with symbols. See http://www.widgit.com/resources/lifeskills/personal-social/ccs/ index.htm. The CCS is divided into 16 sections and is available with either 6, 15 or 45 vocabulary items per page.

[[developing-and-supporting-a-communication]] *Developing and Supporting a Communication Book* is a resource that was developed by the ACE Centre to support families and practitioners in developing a low tech communication book. It suggests a core vocabulary that is developed over five stages, and provides advice on how to support its use. It is available to purchase from the ACE Centre http://acecentre.org.uk/developing-and-using-acommunication-book.

image::o3N4XgO-thumb.jpg[title="Communication Book", alt="Communication Book", width="300", link="Media/images/o3N4XgO.jpg"]

[[look2talk]] *Look2Talk* is a resource developed by the ACE Centre to support families and practitioners in developing a low tech communication book for children who communicate using eye pointing. It shares a similar approach to the Developing and Supporting a Communication book resource, but is optimised for eye pointing. It is available to purchase from the ACE Centre http://acecentre.org.uk/look2talk-complete.

image::MnJRriw-thumb.jpg[title="Look2Talk", alt="Look2Talk", width="300", link="Media/images/MnJRriw.jpg"]

[[the-Pixon-Project-Kit]] *The Pixon Project Kit* (available in the UK from Liberator http://www.liberator.co.uk) is an early language development program based around communication charts. It makes use of Pixon symbols and comes with 10 pre-designed communication boards that can be personalised.

[[PODD-Pragmatic-Organisation-Dynamic-Display]] *PODD (Pragmatic Organisation Dynamic Display)* is a complete communication system that was developed by Australian Speech Pathologist Gayle Porter. The software needed to print out the various levels of Direct Access PODD books is available to purchase in the UK from www.inclusive.co.uk. Templates range from books with 9 cells per page up to 90, with many options in between.
...
--
image::PODD-1-thumb.jpg[title="A simple one page opening PODD communication book Known as 9 per page Expanded Functions.",link="Media/images/PODD-1.jpg"]
image::16PODD-copy-1-thumb.jpg[title="A slightly more complex one page opening PODD communication book known as 16 per Expanded Fuctions.",link="Media/images/16PODD-copy-1.jpg"]
...
image::8wO4cVn-thumb.jpg[title="Symbol Strips", alt="Symbol Strips", width="300", link="Media/images/8wO4cVn.jpg"]

==== Introducing a little voice output

There is now a good range of low cost single message devices that you can attach to the front of a communication book or use alongside a communication book or chart. These can be used to program a simple message like “let’s chat” or “I’ve got something to say” to initiate conversation. You can find such devices on websites like http://www.liberator.co.uk or http://www.inclusive.co.uk.

Another device that can act as a bridge between low tech communication charts or books and voice output communication is a Voice Pen (V Pen). Available from Ability World in the UK (http://www.ability-word.com), the Voice Pen speaks aloud words, sounds or messages when it makes contact with a hidden code within communication charts produced using their special voice symbol software. Here’s an image of the V Pen in action:

image::JtDrCI2-thumb.jpg[title="Voice Pen", alt="Voice Pen", width="300", link="Media/images/JtDrCI2.jpg"]
...
--
image::birthday-picnic-thumb.jpg[title="I had a picnic on my birthday. Lots of my friends came!",link="Media/images/birthday-picnic.jpg"]
image::cakes-thumb.jpg[title="My birthday cakes were teddy bears. They were very chocolatey.",link="Media/images/cakes.jpg"]
...
There are lots of great resources available to help produce a communication passport. See http://www.communicationpassports.org.uk for more information.
...
http://aac.unl.edu/vocabulary.html [accessed on 5/11/2015]

http://www.aacscotland.org.uk/Online-Learning-Modules/ [accessed on 5/11/2015]

http://www.brightpart.org/documents/communicate/OBJECTS%20OF%20REF%20-%20overview.pdf [accessed on 5/11/2015]

http://www.callscotland.org.uk/Common-Assets/quickguides/QG-1408113957.pdf [accessed on 5/11/2015]

http://www.communicationmatters.org.uk/sites/default/files/downloads/focuson/Speaking_with_someone_who_uses_AAC_A4.pdf [accessed
on 17/04/2015]

http://www.communicationpassports.org.uk/Home/ [accessed on 5/11/2015]

http://library.tsbvi.edu/Browse/Category/15 [acessed on
3/12/2015]

http://uk.dynavoxtech.com/implementation-toolkit/details.aspx?id=373 [accessed on 5/11/2015]

http://www.everyonecommunicates.org/resources/literacy.html [accessed 5/11/2015]

http://praacticalaac.org/praactical/research-reviewssupporting-the-use-of-aac/ [accessed 5/11/2015]

http://www.pecs-unitedkingdom.com [accessed 9/11/2015]

https://www.med.unc.edu/ahs/clds/files/how-to-handouts/RemnantBooks_000.pdf [accessed 22/10/2015]

http://www.toby-churchill.com/lightwriter-community/userstories/melinda/ [accessed on 20/10/2014]

http://www.vantatenhove.com/papers.shtml [accessed on 5/11/2015]

http://www.vantatenhove.com/files/handouts/ThePixonProject.pdf [accessed on 5/11/2015]

http://www.widgit.com/resources/lifeskills/personal-social/ccs/index.htm [accessed on 5/11/2015]
